...
export class CreateChannelDto {
  @ApiProperty({ description: '类型: 1-渠道, 2-业务员', example: 1 })
  @IsNumber()
  @IsNotEmpty()
  @Min(1)
  @Max(2)
  ...
  @ApiProperty({ description: '渠道编码', example: 'CH001' })
  @IsString()
  @IsNotEmpty()
  @MinLength(3)
  @MaxLength(50)
  ...
  @ApiProperty({ description: '渠道名称/业务员姓名', example: '北京销售渠道' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(100)
  channelName: string;
  ...
  @ApiProperty({ description: '联系电话', example: '13700137000' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(20)
  contactPhone: string;
