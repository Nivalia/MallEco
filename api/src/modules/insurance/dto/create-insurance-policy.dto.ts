...
export class CreateInsurancePolicyDto {
  @ApiProperty({ description: '保单号', example: 'PAIC20240101000001' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(100)
  policyNumber: string;

  @ApiProperty({ description: '投保人ID', example: '1' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(36)
  ...
  @ApiProperty({ description: '险别', example: '交强险' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(50)
  ...
  @ApiProperty({ description: '失效日期', example: '2025-01-01' })
  @IsDateString()
  @IsNotEmpty()
  expiryDate: Date;
